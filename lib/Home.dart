...
class _HomeState extends State<Home> {
  ...
  void _calcular(){
     ...
     double fator = double.parse(_controllerAlcool.text)/double.parse(_controllerGasolina.text);
     if (alcool==null || gasolina==null){
       setState(() {
         _mensagem = "Use um ponto ao digitar o valor do combustível. Ex. 1.59";
       });
     } else {
